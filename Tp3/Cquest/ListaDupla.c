...
// INSERIR NA LISTA
void InseririnistaDupla(Lista *lista, Jogador x)
{
...
void InserirfimDupla(Lista *lista, Jogador x)
{
...
// REMOVER DA LISTA
Jogador RemoverinListaDupla(Lista *lista)
{
    // validar remocao
    if (lista->size == 0)
    {
...
Jogador RemoverfListaDupla(Lista *lista)
{
...
void mostraListaDupla(Lista *lista)
{
...
Lista newLista()
{
    ...
    lista.InserirInicio = InseririnistaDupla;
    lista.InserirFim = InserirfimDupla;

    lista.RemoverInicio = RemoverinListaDupla;
    lista.RemoverFim = RemoverfListaDupla;

    lista.Mostrar = mostraListaDupla;
